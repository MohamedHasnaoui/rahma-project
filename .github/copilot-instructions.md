# Copilot Instructions for Tajhiz Douaat Project

## Project Overview

This is a React + TypeScript + Vite web application for **Tajhiz Douaat** (تجهيز الدعاة) - an Islamic charitable project. The site is content-heavy with multiple pages for initiatives, donations, and transparency.
...
- All static content (initiatives, stats, contact info) is exported as constants
- Content updates only require editing this file—no database calls needed
- Data exports include: `associationInfo`, `contactInfo`, `socialLinks`, `donationInfo`, `stats`, `initiatives`, `news`, `testimonials`, `faqItems`
