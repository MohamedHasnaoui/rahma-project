...
export const faqItems = [
  ...
  },
  {
    ...
    answer:
      "نعم، نحرص على توجيه التبرعات مباشرة لتوفير الأدوات والتجهيزات للمستفيدين وفق الأولويات المعتمدة لدينا.",
  },
  {
    id: 5,
    question: "ما هي المدن التي يغطيها المشروع؟",
    answer:
      "ينشط مشروعنا في المدن التي نصل إليها عبر مبادراتنا الحالية، وهدفنا التوسع تدريجياً لتغطية أكبر عدد ممكن من مدن المغرب.",
  },
];
